...
enum SampleType {DATA, MC_SIGNAL, MC_BACKGROUND};
...
// Main function
void debug3(TString sampleSubDir, SampleType sampleType){
  ...
  //   return;
  // }
  // TString fullTreeName = rootDirName + TString("/") + treeName;
  // TTree *treeIn = (TTree*)fin->Get(fullTreeName);
  // if( treeIn == 0 ){
