...
#   $4 Suffix added to the sample name for filtered sample written out
#   $5 Sample type
#   $6 section number of this section
#   $7 total number of sections for this sample
...
echo "./processOneSample.py $1 $2 $3 $4 $5 $6 $7"
./filterOneSampleGenMass.py $1 $2 $3 $4 $5 $6 $7
